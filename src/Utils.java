...
public class Utils {
    ...
    /**
     * Copy a Color matrix to another Color matrix. Useful if one does not want to modify the original image.
     * 
    ...
    /**
     * Converts a matrix of Colors into a BufferedImage to write on the filesystem.
     * 
    ...
    /**
     * Converts a file loaded into a BufferedImage to a matrix of Colors
     * 
